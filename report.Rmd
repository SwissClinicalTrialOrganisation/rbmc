...
```
Based on the assumptions fed into the RBM score calculator, the study risk is `r txt` and we thus recommend applying the monitoring strategy for \textbf{`r paste0("\\textcolor[HTML]{", txtcol, "}{", txt, "}")`-risk trials}. 
