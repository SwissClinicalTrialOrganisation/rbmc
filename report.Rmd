...
```
Based on the assumptions fed into the RBM score calculator, the study risk is `r mat[params$overall$row, paste("ClinO", params$input$clino_cat)]` and we thus recommend applying the monitoring strategy for \textbf{`r mat[params$overall$row, paste("ClinO", params$input$clino_cat)]`-risk trials}. 
